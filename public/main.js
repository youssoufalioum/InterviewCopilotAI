...
async function startAssistant() {
  ...
  toggleButton.classList.remove('bg-cyan-500', 'hover:bg-cyan-400');
  toggleButton.classList.add('bg-rose-500', 'hover:bg-rose-400', 'text-white');
  ...
  try {
    ...
    console.error(error);
    setStatus(`Impossible de démarrer: ${error.message}`);
    await stopAssistant();
  }
}
...
async function stopAssistant() {
  ...
  toggleButton.classList.add('bg-cyan-500', 'hover:bg-cyan-400');
  toggleButton.classList.remove('bg-rose-500', 'hover:bg-rose-400', 'text-white');
